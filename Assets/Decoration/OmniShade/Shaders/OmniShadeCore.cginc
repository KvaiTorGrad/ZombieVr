...
//////////////////////////////////////////////////////////////////////////////////////////
	...
	struct v2f {
		...
		#endif
		#if MATCAP
			#if !(NORMAL_MAP || NORMAL_MAP2) && !FLAT
...
half4 frag (v2f i) : COLOR {
	...
	#endif
	#if MATCAP && MATCAP_PERSPECTIVE && ((NORMAL_MAP || NORMAL_MAP2 || NORMAL_MAP_TOP) || FLAT)
	...
	// LIGHTING
		...
		half3 col_diffuse = 0;
		#if !(URP && LIGHTMAP_ON)  // Fix for URP mixed lighting
			if (unity_LightData.z == 1) 
		#endif
		{
		...
		#if !LIGHTMAP_ON  // Light culling mask
			if (unity_LightData.z != 1)
				specColor = 0;
		#endif
